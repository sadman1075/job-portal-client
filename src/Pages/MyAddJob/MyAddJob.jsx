...
const MyAddJob = ({ job }) => {
    ...
    return (
        <div>
            <div className="card bg-base-100 w-full lg:h-[600px] shadow-xl p-4 border-2  mx-1 mt-10 mb-10" data-aos="zoom-in" data-aos-duration="2000">
                ...
                <div className="card-body">
                    ...
                    <div>
                        <Link to={`/view-application/${_id}`} className="btn bg-green-500 text-white mt-4">View Application</Link>
                    </div>
